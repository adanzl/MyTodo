  ...
  <div class="flex gap-4 h-[calc(100vh-220px)]">
      ...
      >
        ...
        >
          ...
          <div class="flex items-center justify-between gap-2">
            ...
            <span v-if="task.duration" class="text-xs text-gray-500 shrink-0">
          ...
          <div class="flex items-center justify-between gap-2 min-h-5">
            ...
            <div class="flex items-center justify-end gap-0 shrink-0 w-23">
              <el-button
    ...
    <div class="flex-1 border rounded p-3 flex flex-col min-h-0" v-if="ttsCurrentTask">
      ...
      <div class="flex-1 flex flex-col gap-3 min-h-0">
        ...
        <!-- 分析数据（中间列底部） -->
        <div class="border rounded p-3 flex flex-col gap-2 flex-shrink-10 h-60">
          <div class="flex items-center justify-between">
    ...
    <div class="w-80 border rounded p-3 flex flex-col" v-if="ttsCurrentTask">
      ...
      <div class="flex-1 overflow-auto flex flex-col gap-3">
        ...
        <!-- 操作按钮 -->
        <div class="border rounded p-3 flex flex-col gap-2 shrink-0">
          <el-tooltip
