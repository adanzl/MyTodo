  ...
  >
    <div v-loading="detailLoading" element-loading-text="加载中..." class="flex min-h-100 h-[80vh] flex-col gap-4">
      ...
      <div class="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
        <div class="flex flex-col h-52 overflow-hidden rounded border border-gray-200">
          <div class="flex items-center justify-between gap-2 border-b border-gray-200 bg-gray-50 p-3 font-bold">
            <span>本地字幕 ({{ sidecarSubtitles.length }})</span>
            <div class="flex items-center">
              <el-select v-model="recognizeLang" size="small" style="width: 88px" class="mr-3">
          ...
          <div class="min-h-0 overflow-y-auto p-3">
            ...
            <div class="flex items-center justify-between gap-2">
              <div class="font-medium text-gray-800">{{ sub.label || sub.path }}
              </div>
        ...
        >
          ...
          <div class="flex shrink-0 gap-2 border-b border-gray-200 p-3 items-center">
            <span>关键词：</span>
            <el-input
          ...
          <el-table :data="subtitleSearchRows" max-height="320" empty-text="未找到字幕">
            <el-table-column prop="language" label="语言" width="88" show-overflow-tooltip />
...
const subtitleSearchPerPage = ref(15);
...
const initVideoDetail = async () => {
  ...
  try {
    ...
    subtitleSearchQuery.value = props.matData.name?.trim() || "";
  } catch (e) {
