        ...
        try:
                ...
                try:
                    ...
                    while cur <= end_d:
                        ...
                        if is_rest_day(rule, cur):
                            ...
                            materials_for_day = daily_materials.get(str(materials_index), []) if isinstance(daily_materials, dict) else []
            ...
            return {
                ...
                "data": {
                    ...
                    'calendar': {item['date']: item for item in calendar_list}
                }
            }
        except Exception as e:
    ...
    def _has_uncompleted_materials(self, task: Dict[str, Any], user_id: int, target_date: datetime) -> bool:
        try:
            ...
            if not materials_for_day:
                return False
            return any(
                (m.get('status') or {}).get(str(user_id)) != 1
