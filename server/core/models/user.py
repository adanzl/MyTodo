...
class User(db_obj.Model):
    ...
    def to_dict(self):
        return {"id": self.id, "name": self.name, "icon": self.icon, "score": self.score, "coin": self.coin, "admin": self.admin, "wish_progress": self.wish_progress, "wish_list": self.wish_list}
