...
def create_todo() -> ResponseReturnValue:
    ...
    try:
        ...
        result = todo_mgr.create_todo(data=json_data)
        return result
    except Exception as e:
...
def get_todo() -> ResponseReturnValue:
    ...
    try:
        ...
        result = todo_mgr.get_todo(todo_id=todo_id)
        return result
    except Exception as e:
...
def update_todo() -> ResponseReturnValue:
    ...
    try:
        ...
        result = todo_mgr.update_todo(todo_id=todo_id, data=json_data)
        return result
    except Exception as e:
...
def save_todo() -> ResponseReturnValue:
    ...
    try:
        ...
        schedule_save.scheduleId = json_data.get('schedule_id')
        schedule_save.date = json_data.get('date')
        ...
        result = todo_mgr.save_todo(schedule_save=schedule_save)
        return result
    except Exception as e:
