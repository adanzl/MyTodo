export const mdiRomanNum1 = `data:image/svg+xml;utf8,
...
`;
export const mdiRomanNum2 = `data:image/svg+xml;utf8,
  <svg class='ionicon' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
    <path d="M11 7v2h-1v6h1v2H7v-2h1V9H7V7zm6 0v2h-1v6h1v2h-4v-2h1V9h-1V7z"/></svg>
`;
export const mdiRomanNum3 = `data:image/svg+xml;utf8,
  <svg class='ionicon' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
    <path d="M9 7v2H8v6h1v2H5v-2h1V9H5V7zm5 0v2h-1v6h1v2h-4v-2h1V9h-1V7zm5 0v2h-1v6h1v2h-4v-2h1V9h-1V7z"/></svg>
`;
export const mdiRomanNum4 = `data:image/svg+xml;utf8,
  <svg class='ionicon' xmlns='http://www.w3.org/2000/svg' width="1em" height="1em" viewBox='0 0 24 24'>
    <path d='m12 7l2 10h2l2-10h-2l-1 5l-1-5zm-1 0v2h-1v6h1v2H7v-2h1V9H7V7z' /></svg>"
`;

export const mdiRomanNums = [mdiRomanNum1, mdiRomanNum2, mdiRomanNum3, mdiRomanNum4];
export default { mdiRomanNums, mdiRomanNum1, mdiRomanNum2, mdiRomanNum3, mdiRomanNum4 };
